...
os.system('python covid19plot.py -perCapita -log -dark -deaths -out top_40_deaths -top 31 40')
os.system('python covid19plot.py -perCapita -log -dark  -out top_40 -top 31 40')
