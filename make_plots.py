...
os.system('python covid19plot.py -perCapita -log -dark -deaths -out Masks_deaths -yFrom 1e-3 -yTo 1e2 -title "Masks deaths" CN KR JP TW TH VN KH MN')
os.system('python covid19plot.py -perCapita -log -dark  -out Masks_Cases -yFrom 1e-3 -yTo 1e3 -title "Masks cases" CN KR JP TW TH VN KH MN')

os.system('python covid19plot.py -perCapita -log -dark -deaths -out NoMasks_deaths -yFrom 1e-3 -yTo 1e2 -title "No masks deaths" IE UK NO SE FI DK NL BE DE CH AT ES FR IT SG')
os.system('python covid19plot.py -perCapita -log -dark  -out NoMasks_Cases -yFrom 1e-3 -yTo 1e3 -title "No masks cases" IE UK NO SE FI DK NL BE DE CH AT ES FR IT SG')
